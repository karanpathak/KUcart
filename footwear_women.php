...
echo "</br>";
echo "</div>";
$sql="SELECT image,productid,productname,price,image FROM productdetails WHERE category='2'";
$result = mysql_query($sql,$conn);
$i=0;
echo "<div class='row'>";
while($row = mysql_fetch_assoc($result)) 
{ if($row['productid']>="11000")
  {
   $i++;
  if ($i>=5)
  {
  ...
  echo "<div class=col-sm-3 col-md-3 col-lg-3 style='text-align:center'>";
    echo "<img src='".$row['image']."' alt='Image' style='width:200px;height:200px'>";
    echo "</br>";
